...
func _process(_delta):
	if Money.Gold <= T1Preis:
		$"Panel11/Button Tower 1/T1 Preis".set("theme_override_colors/font_color", Color(1,0,0))
	if Money.Gold >= T1Preis:
		$"Panel11/Button Tower 1/T1 Preis".set("theme_override_colors/font_color", Color(0,1,0))
	if Money.Gold <= T2Preis:
		$"Panel11/Button Tower 2/T2 Preis".set("theme_override_colors/font_color", Color(1,0,0))
	if Money.Gold >= T2Preis:
		$"Panel11/Button Tower 2/T2 Preis".set("theme_override_colors/font_color", Color(0,1,0))
